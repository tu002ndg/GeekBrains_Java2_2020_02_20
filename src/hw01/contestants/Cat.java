...
public class Cat implements Contestant {
    ...
    private final static int RUN_DISTANCE_DEFAULT = 100;
    private final static int JUMP_HEIGHT_DEFAULT = 150;
    ...
    public int jump() {
        ...
        System.out.printf("The cat '%s' jumps %d%n ",
                name, jumpHeight);
        return jumpHeight;
    }
    ...
    public int run() {
        ...
        System.out.printf("The cat '%s' runs the distance %d%n ",
                name, runDistance);
        return runDistance;
    }
